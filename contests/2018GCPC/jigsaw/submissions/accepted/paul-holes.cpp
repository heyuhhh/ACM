/* Note: This submission has undefined behaviour, which does get
 * triggered by the case 14-hole-and-overlap.in (as running it with
 * valgrind shows), but apparently this is not enough to actually
 * make it crash.
 */
